 ...
 */
package app.com.wonkydan.sunshine.data;
...
public class WeatherProvider extends ContentProvider {
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match){
            case WEATHER:
                deletedRows = sqLiteDatabase.delete(WeatherContract.WeatherEntry.TABLE_NAME, selection, selectionArgs);
                break;
            case LOCATION:
                deletedRows = sqLiteDatabase.delete(
    ...
    public int update(
        ...
        switch (match){
            case WEATHER:
                updatedRows = sqLiteDatabase.update(
            ...
            case LOCATION:
                ...
                break;
            default:
                throw new UnsupportedOperationException("Unrecognised uri: " + uri);
        }
        if (updatedRows != 0){
            getContext().getContentResolver().notifyChange(uri, null);
        }
